...
"""
    ...
    func testRequest() {
        ...
        for t in [arg(data: Data([0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf,
                  ...
                  arg(data: Data([0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf,
                                   ...
                                   0x02, 0x02, 0x04, 0x66, 0x6f, 0x06, 0x1, 0x2, 0x3, 0]),
                      expected: Request(clientHash: [0x0,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf],
                                        clientProtocol: "foo",
                                        serverHash: [0x1,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf],
                                        meta: ["fo":[1,2,3]]))]{
    ...
    func testResponse() {
        ...
        for t in [arg(model: Response(match: HandshakeMatch.BOTH, serverProtocol: nil, serverHash: nil),expected: Data([0,0,0,0])),
                  arg(model: Response(match: HandshakeMatch.CLIENT, serverProtocol: "foo", serverHash: [0x1,0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x9,0xa,0xb,0xc,0xd,0xe,0xf]),
                      expected: Data([2,
                                      0x02,0x06,0x66,0x6f,0x6f,
